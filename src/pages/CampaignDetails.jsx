    ...
    <div>
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
          ...
          <div>
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
              <div className="w-[52px] h-[52px] flex items-center justify-center rounded-full bg-[#2c2f32] cursor-pointer">
                <img src={thirdweb} alt="user" className="w-[60%] h-[60%] object-contain"></img>
              </div>
              <div>
        ...
        <div className="flex-1">
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[12px]">
            ...
            <div className="mt-[20px]">
              <input
                ...
                border-[1px] border-[#3a3a43] bg-transparent font-epilogue text-white
                text-[18px] leading-[30px] placeholder:text-[#4b5264] rounded-[12px]"
                value={amount}
                onChange={(e) => setAmount(e.target.value)}
              />
              <div className="mt-[20px] p-4 bg-[#13131a] rounded-[12px]">
                <h4 className="font-epilogue text-white font-semibold text-[14px] leading-[22px]">
