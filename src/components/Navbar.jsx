  ...
  return (
    <div className='flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6'>
      <div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[100px]">
        <input type="text" placeholder="Search for campaigns" className="flex w-full font-epilogue font-normal 
      ...
      {/*Small screen navigation*/}
        ...
        <div className='sm:hidden flex justify-between items-center relative'> 
          ...
          <div className={`absolute top-[60px] right-0 left-0 bg-[#1c1c24] z-10 shadow-secondary 
            ...
            <ul className='mb-4'>
              {navlinks.map((link) => (
                ...
                >
                  ...
                  />
                  <p className={`ml-[20px] font-epilogue font-semibolt text-[14px] 
